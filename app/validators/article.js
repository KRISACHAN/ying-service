...
export class ArticleValidator extends LinValidator {
    constructor() {
        ...
        this.title = [
            new Rule('isLength', '文章标题 title 不能为空', { min: 1 }),
        ];
        this.img_url = [
        ...
        this.seo_keyword = [
            new Rule('isLength', '文章关键字 seo_keyword 不能为空', { min: 1 }),
        ];
        this.description = [
            new Rule('isLength', '文章简介 description 不能为空', { min: 1 }),
        ];
        this.category_id = [
            new Rule('isLength', '文章分类 category_id 不能为空', { min: 1 }),
        ];
...
export class ArticleSearchValidator extends LinValidator {
    constructor() {
        super();
