...
export class ArticleDao {
    ...
    static async list(params = {}) {
        ...
        try {
            ...
            const [categoryError, dataAndCategory] =
                await ArticleDao._handleCategory(rows, categoryIds);
            if (!categoryError) {
    ...
    static async detail(id) {
        try {
            ...
            const [categoryError, dataAndCategory] =
                await ArticleDao._handleCategory(article, article.category_id);
            if (!categoryError) {
